...
int main(int argc, char* argv[]) {
  ...
  int sko = 0, skz = 0, counts = 0, count1 = 0, countop = 0, countn = 0,
      counto = 0, countz = 0, res = 0, f = 0, strlenstr = 0;
  bool fl1 = false;
  string prres;
      ...
      if (sko == 0) {
        ...
        for (int i = 0; i < counts; i++) {
          ...
          for (int m = 0; m < f - pozso[sko] - prres.length() + 1; m++) {
            for (int j = pozso[sko] + prres.length(); j < strlen(str) - 1;
                 j++) {
              str[j] = str[j + 1];
            }
          }
          for (int j = strlen(str) - (f - pozso[sko]) + prres.length() - 1;
               j < strlen(str); j++) {
            str[j] = 'n';
          }
        }
